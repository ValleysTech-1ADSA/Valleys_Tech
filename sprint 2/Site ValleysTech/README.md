...
- Exemplo, se você quiser a funcionalidade de adicionar um novo Aquário, deve criar arquivos referentes ao hectare nos diretórios e replicar também as funções.  
